module.exports = {
    apps: [
        {
            ...
            // Настройки логов
            log_file: '/home/yc-user/logs/combined.log',
            out_file: '/home/yc-user/logs/out.log',
            error_file: '/home/yc-user/logs/error.log',
    ...
    deploy: {
        production: {
            ...
            host: '89.169.189.202',
            ref: 'origin/main',
            repo: 'git@github.com:makishvili/the-dog-feed.git',
            path: '/home/yc-user/dog-feeding-bot',
            'post-deploy':
                'npm install && npm run build && pm2 reload ecosystem.yandex.config.js --env production && pm2 save',
        },
    },
};
